...
class TestEqnCompare(BaseTest):
    ...
    def test_find_lj_mie_exp6_forms_and_scalars(self):
        ethane_lj = mb.load(get_mosdef_gomc_fn("ethane_ua.mol2"))
        ethane_lj.name = "ETH"
        ethane_mie = mb.load(get_mosdef_gomc_fn("ethane_ua_mie.mol2"))
        ...
        [
            ...
            forcefield_selection={
                "ETH": f"{get_mosdef_gomc_fn('ethane_propane_ua_lorentz_combining.xml')}",
                "ETHM": f"{get_mosdef_gomc_fn('ethane_propane_ua_Mie_lorentz_combining.xml')}",
            },
            residues=["ETH", "ETHM"],
    ...
    def test_bad_eqn_for_find_lj_mie_exp6_forms_and_scalars(self):
        with pytest.raises(
            ...
            [
                ...
                forcefield_selection={
                    "ETH": f"{get_mosdef_gomc_fn('ethane_propane_ua_lorentz_combining.xml')}",
                    "ETHM": f"{get_mosdef_gomc_fn('ethane_propane_ua_bad_eqn_lorentz_combining.xml')}",
                },
                residues=["ETH", "ETHM"],
                boxes_for_simulation=1,
            )
