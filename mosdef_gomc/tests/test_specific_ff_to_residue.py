...
class TestSpecificFFToResidue(BaseTest):
    ...
    def test_specific_ff_params_benzene_water_aa(self):
        benzene_aa = mb.load(get_mosdef_gomc_fn("benzene_aa.mol2"))
        benzene_aa.name = "BEN"
        ...
        [
            ...
            test_box,
            forcefield_selection={
                benzene_aa.name: f"{get_mosdef_gomc_fn('benzene_GAFF.xml')}",
                water_aa.name: f"{get_mosdef_gomc_fn('gmso_spce_water__lorentz_combining.xml')}",
            },
