...
class TestGOMCControlFileWriter(BaseTest):
    ...
    def test_save_basic_GEMC_NVT(self, ethane_gomc):
        ...
        with open("test_save_basic_GEMC_NVT.conf", "r") as fp:
            ...
            for i, line in enumerate(out_gomc):
                ...
                elif line.startswith("VolumeFreq "):
                    variables_read_dict["RotFreq"] = True
                    split_line = line.split()
    ...
    def test_save_basic_GEMC_NPT(self, ethane_gomc):
        ...
        gomc_control.write_gomc_control_file(
            ...
            input_variables_dict={
                ...
                "useConstantArea": True,
                "FixVolBox0": True,
                "RcutCoulomb_box_0": 14 * u.angstrom,
                "RcutCoulomb_box_1": 14 * u.angstrom,
            },
        )
        ...
        with open("test_save_change_most_variable_NVT.conf", "r") as fp:
            ...
            for i, line in enumerate(out_gomc):
                if line.startswith("Restart "):
                    ...
                    variables_read_dict["Rcut"] = True
                    split_line = line.split()
                    assert split_line[1] == "12.0"

                elif line.startswith("RcutLow "):
                    variables_read_dict["RcutLow"] = True
                    split_line = line.split()
                    assert split_line[1] == "1.0"
    ...
    def test_save_NVT_bad_variables_part_7(self, ethane_gomc, ethanol_gomc):
        ...
        with pytest.warns(
            ...
            gomc_control.write_gomc_control_file(
                charmm,
                "test_RcutLow_not_0_for_free_energy",
                "NVT",
                1000,
                300 * u.K,
                check_input_files_exist=False,
    ...
    def test_save_bad_variables_part_8(self, ethane_gomc, ethanol_gomc):
        test_box_ethane_ethanol = mb.fill_box(
            compound=[ethane_gomc, ethanol_gomc],
            n_compounds=[1, 1],
            box=[4.0, 4.0, 4.0],
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                charmm,
                "test_save_bad_variables_part_8.conf",
                "GEMC_NVT",
                10,
                300 * u.K,
                check_input_files_exist=False,
        ...
        try:
            gomc_control.write_gomc_control_file(
                ...
                input_variables_dict={
                    ...
                    "IntraMEMC-3Freq": 0.10,
                    "MEMC-3Freq": 0.10,
                    "ChemPot": {"ETH": -4000 * u.K, "ETO": 8000 * u.K},
                },
            )
        except:
            value = "TEST_FAILED"
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                ...
                input_variables_dict={
                    ...
                    "IntraMEMC-3Freq": 0.20,
                    "MEMC-3Freq": 0.20,
                    "Fugacity": {"ETH": 0 * u.bar, "ETO": 1.0 * u.bar},
                },
            )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                ...
                input_variables_dict={
                    ...
                    "DisFreq": 1,
                    "Fugacity": {1: 0 * u.bar, "ETO": 1.0 * u.bar},
                },
            )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                ...
                input_variables_dict={
                    ...
                    "DisFreq": 1,
                    "Fugacity": {"ETH": -1 * u.bar, "ETO": 1.0 * u.bar},
                },
            )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                ...
                input_variables_dict={
                    ...
                    "DisFreq": 1,
                    "Fugacity": {"ETH": 2 * u.bar, "ETO": 1.0 * u.bar},
                },
            )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                ...
                input_variables_dict={
                    "DisFreq": 1,
                    "Fugacity": {"ETH": 0 * u.bar, "XXX": 1.0 * u.bar},
                },
            )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                ...
                input_variables_dict={
                    "DisFreq": 1,
                    "Fugacity": {"XXX": 0 * u.bar, "ETO": 1.0 * u.bar},
                },
            )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                ...
                input_variables_dict={
                    "DisFreq": 1,
                    "ChemPot": {1: -4000 * u.K, "ETO": -8000 * u.K},
                },
            )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                ...
                input_variables_dict={
                    "DisFreq": 1,
                    "ChemPot": {"XXX": -4000 * u.K, "ETO": -8000 * u.K},
                },
            )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                ...
                input_variables_dict={
                    "DisFreq": 1,
                    "ChemPot": {"ETH": -4000 * u.K, "XXX": -8000 * u.K},
                },
            )
    ...
    def test_restarting_pdb_psf_NVT(self, ethane_gomc):
        ...
        gomc_control.write_gomc_control_file(
            ...
            1000,
            300 * u.K,
            ff_psf_pdb_file_directory="../Test_1",
            Parameters="../test_folder/new.par",
            Restart=True,
            Checkpoint=[True, "../Test_2/Output_data.chk"],
            check_input_files_exist=False,
            input_variables_dict={},
        )
        ...
        with open("test_restarting_pdb_psf_NVT.conf", "r") as fp:
            ...
            for i, line in enumerate(out_gomc):
                if line.startswith("Parameters "):
                    ...
                    split_line = line.split()
                    assert split_line[1] == "0"
                    assert split_line[2] == "../Test_1/ethane_box_0.pdb"

                elif line.startswith("Structure 0 "):
                    variables_read_dict["Structure_box_0"] = True
                    split_line = line.split()
                    assert split_line[1] == "0"
                    assert split_line[2] == "../Test_1/ethane_box_0.psf"
                    ...
                    split_line = line.split()
                    assert split_line[1] == "True"
                    assert split_line[2] == "../Test_2/Output_data.chk"
        ...
        with open(
            ...
            for i, line in enumerate(out_gomc):
                if line.startswith("Coordinates 0 "):
                    ...
                    split_line = line.split()
                    assert split_line[1] == "True"
                    assert split_line[2] == "../../Folder_1/test_checkpoint.chk"
        ...
        with open(
            ...
            for i, line in enumerate(out_gomc):
                if line.startswith("Coordinates 0 "):
                    ...
                    split_line = line.split()
                    assert split_line[1] == "True"
                    assert split_line[2] == "test_checkpoint.chk"
    ...
    def test_save_basic_GCMC_use_targetedswap_fugacity(
        ...
        gomc_control.write_gomc_control_file(
            ...
            input_variables_dict={
                ...
                "TargetedSwapFreq": 0.10,
                "IntraTargetedSwapFreq": 0.10,
                "Fugacity": {"ETH": 4.44 * u.bar, "ETO": 5.55 * u.bar},
                "TargetedSwap_DataInput": {
                    0: {
                        "SubVolumeType": "dynamic",
                        "SubVolumeBox": 0,
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                ...
                input_variables_dict={
                    ...
                    "VolFreq": 0.0,
                    "TargetedSwapFreq": 0.20,
                    "Fugacity": {"ETH": 4.44 * u.atm, "ETO": 5.55 * u.atm},
                    "TargetedSwap_DataInput": {
                        0: {
                            "SubVolumeType": 0,
                            "SubVolumeBox": 0,
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                ...
                input_variables_dict={
                    ...
                    "VolFreq": 0.0,
                    "TargetedSwapFreq": 0.20,
                    "ChemPot": {"ETH": 4.44 * u.K, "ETO": 5.55 * u.K},
                    "TargetedSwap_DataInput": {
                        0: {
                            "SubVolumeType": "dynamic",
                            "SubVolumeBox": 0,
                ...
                input_variables_dict={
                    ...
                    "TargetedSwap_DataInput": {
                        0: {
                            ...
                            "SubVolumeBox": 0,
                            "SubVolumeCenterList": ["1-6", 7, 8],
                            "SubVolumeDim": [1, 2, 3, 4] * u.angstrom,
                            "SubVolumeResidueKind": ["ETH", "ETO"],
                            "SubVolumeRigidSwap": True,
                            "SubVolumePBC": "XY",
                            "SubVolumeFugacity": {"ETH": 2.22 * u.bar, "ETO": 0.22 * u.bar},
                ...
                input_variables_dict={
                    ...
                    "TargetedSwap_DataInput": {
                        0: {
                            "SubVolumeType": "static",
                            "SubVolumeBox": 0,
                            "SubVolumeCenter": [1, 1, 1, 1] * u.angstrom,
                            "SubVolumeDim": [3, 2, 1] * u.angstrom,
                            "SubVolumeResidueKind": "All",
                            "SubVolumeRigidSwap": True,
                            "SubVolumePBC": "XY",
                ...
                input_variables_dict={
                    ...
                    "TargetedSwap_DataInput": {
                        0: {
                            0: "static",
                            "SubVolumeBox": 0,
                            "SubVolumeCenter": [1, 1, 1] * u.angstrom,
                            "SubVolumeDim": [3, 2, 1] * u.angstrom,
                            "SubVolumeResidueKind": "all",
                            "SubVolumeRigidSwap": True,
                            "SubVolumePBC": "XY",
                ...
                input_variables_dict={
                    ...
                    "TargetedSwap_DataInput": {
                        0: {
                            "SubVolumeType": "static",
                            "SubVolumeBox": 1,
                            "SubVolumeCenter": [1, 7, 8] * u.angstrom,
                            "SubVolumeResidueKind": ["ETH", "ETO"],
                            "SubVolumeRigidSwap": True,
                            "SubVolumePBC": "XY",
                        },
    ...
    def test_RcutCoulomb_box_0_and_1_unyt_tests(self, ethane_gomc):
        test_box_ethane_gomc = mb.fill_box(
            compound=[ethane_gomc], n_compounds=[1], box=[1, 1, 1]
        )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                charmm,
                "test_RcutCoulomb_unyt_inputs",
                "GEMC-NVT",
                1000,
                300 * u.K,
                check_input_files_exist=False,
                input_variables_dict={
                    r_cut_coul_str: r_cut_coul_value,
                    "VDWGeometricSigma": True,
                },
            )
    ...
    def test_pressure_unyt_tests(self, ethane_gomc):
        test_box_ethane_gomc = mb.fill_box(
            compound=[ethane_gomc], n_compounds=[1], box=[1, 1, 1]
        )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                charmm,
                "test_pressure_unyt_inputs",
                "NVT",
                1000,
                300 * u.K,
                check_input_files_exist=False,
                input_variables_dict={
                    pressure_str: pressure_value,
                    "VDWGeometricSigma": True,
                },
            )
    ...
    def test_Rcut_RcutLow_Rswitch_unyt_tests(self, ethane_gomc):
        test_box_ethane_gomc = mb.fill_box(
            compound=[ethane_gomc], n_compounds=[1], box=[1, 1, 1]
        )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                charmm,
                "test_Rcut_unyt_inputs",
                "NVT",
                1000,
                300 * u.K,
                check_input_files_exist=False,
                input_variables_dict={
                    r_cut_str: r_cut_value,
                    "VDWGeometricSigma": True,
                },
            )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                charmm,
                "test_RcutLow_unyt_inputs",
                "NVT",
                1000,
                300 * u.K,
                check_input_files_exist=False,
                input_variables_dict={
                    r_cut_low_str: r_cut_low_value,
                    "VDWGeometricSigma": True,
                },
            )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                charmm,
                "test_Rswitch_unyt_inputs",
                "NVT",
                1000,
                300 * u.K,
                check_input_files_exist=False,
                input_variables_dict={
                    r_switch_str: r_switch_value,
                    "VDWGeometricSigma": True,
                },
            )
    ...
    def test_MinSigma_unyt_tests(self, ethane_gomc, ethanol_gomc):
        test_box_ethane_ethanol = mb.fill_box(
            compound=[ethane_gomc, ethanol_gomc],
            n_compounds=[1, 1],
            box=[1, 1, 1],
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                charmm,
                "test_MinSigma_unyt_inputs",
                "NVT",
                100,
                300 * u.K,
                check_input_files_exist=False,
                input_variables_dict={
                    min_sigma_str: min_sigma_value,
                    "FreeEnergyCalc": [True, 10],
                    "MoleculeType": ["ETH", 1],
                    "InitialState": 3,
    ...
    def test_ChemPot_unyt_tests(self, ethane_gomc):
        test_box_ethane_gomc = mb.fill_box(
            compound=[ethane_gomc], n_compounds=[1], box=[2, 2, 2]
        )
        charmm = Charmm(
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                charmm,
                "test_SubVolumeChemPot_inputs.conf",
                "GCMC",
                1000,
                500 * u.K,
                ExpertMode=False,
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                charmm,
                "test_Fugacity_unyt_inputs.conf",
                "GCMC",
                10,
                300 * u.K,
                check_input_files_exist=False,
                input_variables_dict={
                    fugacity_str: {"ETH": fugacity_value},
                },
            )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                charmm,
                "test_SubVolumeFugacity_inputs.conf",
                "GCMC",
                1000,
                500 * u.K,
                ExpertMode=False,
    ...
    def test_warning_if_geometric_mixing_used(self, ethane_gomc):
        test_box_ethane_gomc = mb.fill_box(
            compound=[ethane_gomc], n_compounds=[1], box=[1, 1, 1]
        )
        charmm = Charmm(
        ...
        with pytest.warns(
            ...
            gomc_control.write_gomc_control_file(
                charmm,
                "warning_if_geometric_mixing_used.conf",
                "NVT",
                10,
                300 * u.K,
                check_input_files_exist=False,
    ...
    def test_default_VDWGeometricSigma_if_True(self, water):
        ...
        gomc_control.write_gomc_control_file(
            charmm,
            "test_default_VDWGeometricSigma_if_True.conf",
            "NVT",
            10,
            300 * u.K,
            check_input_files_exist=False,
        ...
        with open("test_default_VDWGeometricSigma_if_True.conf", "r") as fp:
            variables_read_dict = {
                "VDWGeometricSigma": False,
            }
            out_gomc = fp.readlines()
    ...
    def test_check_VDWGeometricSigma_if_set_False(self, water):
        test_box_water_gomc = mb.fill_box(
            compound=[water], n_compounds=[1], box=[1, 1, 1]
        )
        charmm = Charmm(
    ...
    def test_restarting_pdb_psf_restart_checkpoint_true_NVT(self, ethane_gomc):
        test_box_ethane_gomc = mb.fill_box(
            compound=[ethane_gomc], n_compounds=[1], box=[1, 1, 1]
        )
        ...
        gomc_control.write_gomc_control_file(
            ...
            300 * u.K,
            ff_psf_pdb_file_directory="../Test_1",
            Parameters="../test_folder_3/new.inp",
        ...
        with open("test_restarting_pdb_psf_NVT.conf", "r") as fp:
            ...
            for i, line in enumerate(out_gomc):
                if line.startswith("Parameters "):
                    variables_read_dict["Parameters"] = True
                    split_line = line.split()
                    assert split_line[1] == "../test_folder_3/new.inp"

                elif line.startswith("Coordinates 0 "):
                    variables_read_dict["Coordinates_box_0"] = True
                    split_line = line.split()
                    assert split_line[1] == "0"
                    assert split_line[2] == "../test_folder_1/new.pdb"

                elif line.startswith("Structure 0 "):
                    variables_read_dict["Structure_box_0"] = True
                    split_line = line.split()
                    assert split_line[1] == "0"
                    assert split_line[2] == "../test_folder_2/new.psf"
                    ...
                    split_line = line.split()
                    assert split_line[1] == "True"
                    assert split_line[2] == "Output.chk"
    ...
    def test_restarting_pdb_psf_restart_checkpoint_false_without_filename_GEMC_NVT(self, ethane_gomc):
        ...
        gomc_control.write_gomc_control_file(
            ...
            Coordinates_box_0="../test_folder_1/new.pdb",
            Structure_box_0="../test_folder_2/new.psf",
            Coordinates_box_1="../test_folder_11/new.pdb",
            Structure_box_1="../test_folder_12/new.psf",
            Restart=True,
            Checkpoint=False,
            check_input_files_exist=False,
            input_variables_dict={},
        ...
        with open("test_restarting_pdb_psf_GEMC_NVT.conf", "r") as fp:
            ...
            for i, line in enumerate(out_gomc):
                if line.startswith("Parameters "):
                    ...
                    split_line = line.split()
                    assert split_line[1] == "1"
                    assert split_line[2] == "../test_folder_11/new.pdb"

                elif line.startswith("Structure 1 "):
                    variables_read_dict["Structure_box_1"] = True
                    split_line = line.split()
                    assert split_line[1] == "1"
                    assert split_line[2] == "../test_folder_12/new.psf"
    ...
    def test_coor_xsc_vel_list_or_no_extension_errors(self, ethane_gomc):
        ...
        with pytest.raises(
           ...
           gomc_control.write_gomc_control_file(
                ...
                300 * u.K,
                check_input_files_exist=False,
                binCoordinates_box_0="../test_files/NVT_ethane_box_0.psf",
                extendedSystem_box_0="../test_files/NVT_ethane_box_0.xsc",
                binVelocities_box_0="../test_files/NVT_ethane_box_0.vel",
                binCoordinates_box_1="../test_files/NVT_ethane_box_1.coor",
                extendedSystem_box_1="../test_files/NVT_ethane_box_1.xsc",
        ...
        with pytest.raises(
           ...
           gomc_control.write_gomc_control_file(
                ...
                check_input_files_exist=False,
                binCoordinates_box_0="../test_files/NVT_ethane_box_0.coor",
                extendedSystem_box_0="../test_files/NVT_ethane_box_0.pdb",
                binVelocities_box_0="../test_files/NVT_ethane_box_0.vel",
                binCoordinates_box_1="../test_files/NVT_ethane_box_1.coor",
                extendedSystem_box_1="../test_files/NVT_ethane_box_1.xsc",
                binVelocities_box_1="../test_files/NVT_ethane_box_1.vel",
        ...
        with pytest.raises(
           ...
           gomc_control.write_gomc_control_file(
                ...
                binCoordinates_box_0="../test_files/NVT_ethane_box_0.coor",
                extendedSystem_box_0="../test_files/NVT_ethane_box_0.xsc",
                binVelocities_box_0="../test_files/NVT_ethane_box_0.csv",
                binCoordinates_box_1="../test_files/NVT_ethane_box_1.coor",
                extendedSystem_box_1="../test_files/NVT_ethane_box_1.xsc",
                binVelocities_box_1="../test_files/NVT_ethane_box_1.vel",
                input_variables_dict={},
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                ...
                extendedSystem_box_0="../test_files/NVT_ethane_box_0.xsc",
                binVelocities_box_0="../test_files/NVT_ethane_box_0.vel",
                binCoordinates_box_1="../test_files/NVT_ethane_box_1.txt",
                extendedSystem_box_1="../test_files/NVT_ethane_box_1.xsc",
                binVelocities_box_1="../test_files/NVT_ethane_box_1.vel",
                input_variables_dict={},
            )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                ...
                binVelocities_box_0="../test_files/NVT_ethane_box_0.vel",
                binCoordinates_box_1="../test_files/NVT_ethane_box_1.coor",
                extendedSystem_box_1="../test_files/NVT_ethane_box_1.xml",
                binVelocities_box_1="../test_files/NVT_ethane_box_1.vel",
                input_variables_dict={},
            )
        ...
        with pytest.raises(
            ...
            gomc_control.write_gomc_control_file(
                ...
                binCoordinates_box_1="../test_files/NVT_ethane_box_1.coor",
                extendedSystem_box_1="../test_files/NVT_ethane_box_1.xsc",
                binVelocities_box_1="../test_files/NVT_ethane_box_1.tmp",
                input_variables_dict={},
            )
    ...
    def test_save_Mie_conf_config(self, two_propanol_ua):
        ...
        with open("charmm_data_Mie_UA.conf", "r") as fp:
            variables_read_dict = {
                "ParaTypeMie": False,
                "Parameters": False,
                "Coordinates_box_0": False,
            ...
            for i, line in enumerate(out_gomc):
                if line.startswith("ParaTypeMie "):
                    ...
                    variables_read_dict["Parameters"] = True
                    split_line = line.split()
                    assert split_line[1] == "charmm_data_Mie_UA.inp"

                elif line.startswith("Coordinates 0 "):
                    variables_read_dict["Coordinates_box_0"] = True
                    split_line = line.split()
                    assert split_line[1] == "0"
                    assert split_line[2] == "charmm_data_Mie_UA.pdb"

                elif line.startswith("Structure 0 "):
                    variables_read_dict["Structure_box_0"] = True
                    split_line = line.split()
                    assert split_line[1] == "0"
                    assert split_line[2] == "charmm_data_Mie_UA.psf"
    ...
    def test_lj_mosdef_gomc_nb_not_match_set_one(self, ethane_gomc):
        with pytest.warns(
            ...
            charmm = Charmm(
                test_box_ethane_gomc,
                "test_lj_mosdef_gomc_nb_not_match_set_one",
                structure_box_1=None,
                filename_box_1=None,
                ff_filename="test_lj_mosdef_gomc_nb_not_match_set_one_FF",
                residues=[ethane_gomc.name],
                forcefield_selection="oplsaa",
            )
