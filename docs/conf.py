# -*- coding: utf-8 -*-
#
# NDM documentation build configuration file, created by
...
project = 'MoSDeF-GOMC'
author = 'Crawford, Brad  and Timalsina, Umesh and Quach, Co ' \
...
htmlhelp_basename = 'MoSDeF-GOMC_doc'
